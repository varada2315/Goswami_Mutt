...
export function Gallery() {
  ...
  const images = [
    { src: "hero-hotel.jpeg", alt: "Hotel Exterior", span: "md:col-span-2 md:row-span-2" },
  ...
  return (
    <section id="gallery" className="py-24 bg-[#1A110B] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
          ...
          <h2 className="text-4xl md:text-5xl font-serif font-bold">Discover Our Hotel</h2>
